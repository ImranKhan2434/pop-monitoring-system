...
const CurrentChart1 = ({range, setRange, data = []}) => {
      ...
      <section>
        <div className='card py-5 pb-0 px-4 shadow'>
          <div className='d-flex justify-content-between align-items-center'>
            <div style={{color: '#FFE300'}} className='card-label fw-bold fs-2'>
              Current
            </div>
